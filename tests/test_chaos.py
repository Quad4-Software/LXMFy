...
from lxmfy.storage import Storage, JSONStorage, SQLiteStorage
...
class FailingStorageBackend:
    ...
    def delete(self, key): return self.real.delete(key)
    def exists(self, key): return self.real.exists(key)
    def scan(self, prefix): return self.real.scan(prefix)
