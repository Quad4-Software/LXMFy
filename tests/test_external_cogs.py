...
def test_external_cog_loading(external_cog_setup):
...
def test_external_cog_execution(external_cog_setup):
...
def test_external_cog_disabled(external_cog_setup):
...
def test_external_cog_timeout(external_cog_setup):
...
def test_external_cog_no_timeout(external_cog_setup):
